...
public class ChatClient extends JFrame implements ActionListener {
    ...
    public void actionPerformed( ActionEvent e ) {
        ...
        if( e.getSource() == chatField ) {System.out.println("发送");
            if( cc != null ) {
//                try {
...
//            location = "ws://localhost:7788/huoju-supernode/myHandler";
            location = "ws://localhost:7788/huoju-supernode/portfolio";
