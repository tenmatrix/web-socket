...
//    static final String URL = System.getProperty("url", "ws://127.0.0.1:8080/websocket");
    static final String URL = System.getProperty("url", "ws://127.0.0.1:7788/myhandler");
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Channel ch = b.connect(uri.getHost(), port).sync().channel();//通道建立阻塞
            handler.handshakeFuture().sync();//握手操作执行完成前阻塞

            BufferedReader console = new BufferedReader(new InputStreamReader(System.in,Charset.forName("utf-8")));
            while (true) {
                ...
                if (msg == null) {
                    ...
                    WebSocketFrame frame = new TextWebSocketFrame(new String(msg.getBytes(),Charset.forName("utf-8")));
                    ch.writeAndFlush(frame);
                }
            }
        } finally {
